(function() {
    ...
    function i(t, s, r) {
        this.slider = t, this.parameters = e.extend({}, r), "vertical" === s ? this.parseEvent = i.prototype.parseEventVertical : this.parseEvent = i.prototype.parseEventHorizontal, e(document).on("keydown", e.proxy(this.onKeyDown, this)), t.controls.keyboard = this
    }
    ...
    }, i.prototype.parseEventHorizontal = function(e) {
        switch (e.keyCode) {
            case 39:
    ...
    }, i.prototype.parseEventVertical = function(e) {
        switch (e.keyCode) {
            case 40:
    ...
    function i(t) {
        this.preventScroll = !1, this.preventScrollGlobal = !1, this.slider = t, t.sliderElement.on("wheel", e.proxy(this.onMouseWheel, this)), t.controls.mouseWheel = this
    }
    return i.prototype.onMouseWheel = function(e) {
        if (this.preventScroll === !1) {
            var t = e.originalEvent.deltaY < 0;
            t ? this.slider.isChangeCarousel("previous") && this.slider.parameters.controls.blockCarouselInteraction || (this.slider.previous(), e.preventDefault(), this.preventRepeat(), this.preventGlobal()) : this.slider.isChangeCarousel("next") && this.slider.parameters.controls.blockCarouselInteraction || (this.slider.next(), e.preventDefault(), this.preventRepeat(), this.preventGlobal())
        } else e.preventDefault(), this.preventRepeat(e)
    }, i.prototype.preventRepeat = function() {
        this.preventScroll !== !1 && clearTimeout(this.preventScroll), this.preventScroll = setTimeout(e.proxy(function() {
        ...
        this.preventScrollGlobal !== !1 && clearTimeout(this.preventScrollGlobal), this.preventScrollGlobal = setTimeout(e.proxy(function() {
    ...
    return i.prototype.initTouch = function() {
        ...
        if (!s || "unknown" !== this.currentInteraction.action) {
            this.currentInteraction.diection = this.measure(i);
            var r = this.get(i);
        ...
        ("vertical" === this.axis || n2const.isEdge) && (this.slider.controlFullscreen.isFullScreen || (this.currentInteraction.action = "scroll", "pointer" === this.currentInteraction.type && this.$window.scrollTop(Math.max(0, this.currentInteraction.scrollTop - e))))
    }, i.prototype.recognizeSwitchInteraction = function() {
        if ("unknown" === this.currentInteraction.action)
            if ("ended" === this._animation.state) {
                var e = this.currentInteraction.diection;
        ...
        var i = !1;
        for (var s in e) this.state[s] !== e[s] && (this.state[s] = e[s],
            i = !0);
    ...
    return i.OrientationMode = {
        ...
        if (this.orientation !== v && (this.orientation = v, f = !0, this.sliderElement.trigger("SliderOrientation", {
            ...
            var w = 0;
            if ("100vh" === this.parameters.sliderHeightBasedOn) w = this.$viewportHeight.height();
    ...
    return i.YTDeferred = null, i.prototype.ready = function(s) {
        null === i.YTDeferred && (i.YTDeferred = e.Deferred(), window.YT === t && e.getScript("https://www.youtube.com/iframe_api"), function(e) {
            var i = function() {
                ...
                onStateChange: e.proxy(function(e) {
                    switch (e.data) {
                        ...
                        case YT.PlayerState.BUFFERING:
                            this.isStatic || this.slider.sliderElement.trigger("mediaStarted", this.playerId), t.triggerHandler("n2play");
                            break;
        ...
        t > 0 ? this.setVolume(t) : -1 !== t && this.player.mute(), (this.isStatic || -1 !== e.inArray(this.slide, this.slider.getActiveSlidesCompat(this.slider.currentSlide))) && this.setState("slide", !0, !0), 1 == this.parameters.autoplay && this.slider.visible(e.proxy(this.initAutoplay, this)), this.isStatic || (this.slider.sliderElement.on("mainAnimationStart", e.proxy(function(t, i, s, r) {
            ...
            -1 == e.inArray(this.slide, this.slider.getVisibleSlides(this.slider.slides[r])) && this.player.seekTo(this.parameters.start)
        ...
        this.isStopped() && (this.coverFadedOut === t && setTimeout(e.proxy(this.fadeOutCover, this), 200),
